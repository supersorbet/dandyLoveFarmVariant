...
contract DandyV2 is ERC20, Ownable {
    ...
    uint32 public transferCooldown = 0; // Cooldown in seconds between transfers
    ...
    constructor(string memory tokenName, string memory tokenSymbol) {
        ...
        _setAddressExclusions(msg.sender, true, true, true);
        _setAddressExclusions(DEAD, true, true, true);
        _setAddressExclusions(address(0), true, true, true);
        _setAddressExclusions(address(this), true, true, true);
    }
